...
<?= form_open('config/saveInfo/', ['id' => 'info_config_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) ?>
    <div id="config_wrapper">
        <fieldset id="config_info">
            ...
            <div class="form-group form-group-sm">
                <?= form_label('GSTIN Number', 'tax_id', ['class' => 'control-label col-xs-2']) ?>
                <div class="col-xs-6">
                    <div class="input-group">
                        <span class="input-group-addon input-sm">
                        ...
                        <?= form_input([
                            ...
                            'class' => 'form-control input-sm',
                            'value' => $config['tax_id'],
                            'placeholder' => 'e.g., 36EPAPM4079E1ZU'
                        ]) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                <?= form_label('Terms & Conditions', 'return_policy', ['class' => 'control-label col-xs-2 required']) ?>
                <div class="col-xs-6">
                    <?= form_textarea([
                        'name'  => 'return_policy',
                        'id'    => 'return_policy',
                        ...
                        'placeholder' => 'Enter your terms and conditions, exchange policy, return policy, etc.'
                    ]) ?>
                </div>
            </div>
