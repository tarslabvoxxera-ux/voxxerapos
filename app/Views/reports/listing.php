    ...
    <div class="col-md-4">
        <div class="panel panel-primary">
            ...
            <div class="list-group">
                ...
                ?>
                <?php if (in_array('reports_customers', $permission_ids, true) || in_array('reports_sales', $permission_ids, true)) { ?>
                    <a class="list-group-item" href="<?= site_url('reports/customer_history_input') ?>">
                        <span class="glyphicon glyphicon-user"></span> Customer Purchase History
                    </a>
                <?php } ?>
                <?php if (in_array('reports_sales', $permission_ids, true)) { ?>
                    <a class="list-group-item" href="<?= site_url('reports/comprehensive_sales_input') ?>">
                        <span class="glyphicon glyphicon-download-alt"></span> Comprehensive Sales (Excel Export)
                    </a>
                    <a class="list-group-item" href="<?= site_url('receipts') ?>">
                        <span class="glyphicon glyphicon-file"></span> Saved Receipts (PDF Archive)
                    </a>
                <?php } ?>
            </div>
        </div>
